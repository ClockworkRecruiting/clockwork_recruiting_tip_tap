...
export interface MentionFeedItem {
  ...
  onSelect?: (payload: { selectedItem: MentionFeedItem; marker: string }) => void;
...
export type MentionFeed = (
  text: string,
  clickedItem: MentionFeedItem | undefined,
  updateFeed: MentionFeedUpdate
) => MentionFeedItem[] | Promise<MentionFeedItem[]> | void;
...
export interface EditorConfig {
  ...
  mention?: { feeds?: MentionFeedConfig[] };
  typing?: { transformations?: { remove?: string[] } };
...
export type UploadHandler = (
  file: File,
  context: { onProgress: (progress: UploadProgress) => void; signal: AbortSignal }
